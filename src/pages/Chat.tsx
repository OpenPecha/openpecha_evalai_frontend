          ...
          <div className="flex items-center space-x-3">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Compare AI models and vote for better responses
              </p>
            </div>
          </div>
          ...
          <div className="h-full flex items-center justify-center p-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
                Welcome to Model Arena
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
                Ask questions and compare responses from different AI models.
                Vote for the better response to help improve AI evaluation.
              </p>
      ...
      <div className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mt-3">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Two anonymous models will respond to your question
            </p>
